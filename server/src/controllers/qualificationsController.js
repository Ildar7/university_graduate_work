import { getQualifications as getQualificationsModel, getQualificationById as getQualificationByIdModel } from '../models/Qualification.js';

export const getQualifications = async (req, res) => {
    try {
        const { page = 1, limit = 50, sort = 'id_qual', order = 'asc' } = req.query;

        const validSortFields = ['id_qual'];
