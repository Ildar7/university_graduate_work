import { getTypeoftrainings as getTypeoftrainingsModel, getTypeoftrainingById as getTypeoftrainingByIdModel } from '../models/Typeoftraining.js';

export const getTypeoftrainings = async (req, res) => {
    try {
        const { page = 1, limit = 50, sort = 'id_typeoftraining', order = 'asc' } = req.query;

        const validSortFields = ['id_typeoftraining'];
